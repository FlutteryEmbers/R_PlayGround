...
#SBATCH --job-name=getNetworkTAM112up      #Set the job name to "JobExample2"
#SBATCH --time=120:00:00               #Set the wall clock limit to 6hr and 30min
...
#SBATCH --mem=30G                   #60G for hisat-build  #Request 8GB per node 
#SBATCH --output=terra_out/getNetworkTAM112up_B_out.%j      #Send stdout/err to "Example2Out.[jobID]" 
...
Rscript terra_cluster_JGL_B_2.R
#Rscript Test.R
